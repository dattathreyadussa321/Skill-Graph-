...
try:
    ...
    neo4j_password = os.getenv('PASSWORD', 'neo4jpass')
    neo4j_url = os.getenv('URL', 'localhost:7687')
    neomodel_config.DATABASE_URL = f'bolt://{neo4j_user}:{neo4j_password}@{neo4j_url}'
...
# Database - SQLite for Django internals only (Neo4j is primary)
DATABASES = {
    'default': {
